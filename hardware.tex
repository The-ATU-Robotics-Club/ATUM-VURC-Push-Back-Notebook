...
[Image of engineering design cycle diagram]
...
\begin{table}[H]
    ...
    (-) \textbf{Compromise:} The old drive (Legacy 8-Motor) is less powerful than our VURC target (10-Motor), but sufficient for testing. & \textbf{Yes} \\ \hline
    \end{tabular}
\end{table}
...
\subsection{Top Stage}
    ...
    \subsubsection{Iteration 2}
    With the bottom stage sorted out, Custom prints were used on the stop stage in order to achieve a desired geometry for the 1st iteration. 

...
\section{Pivot}
    ...
    This section goes over the pivot point for the senior design chapter, and all if any problems that occurred during the manufacturing/building process. 
    \newline

\subsection{Iteration 1}

    With most of the problems solved during prototyping the only problem was to remake the axle in order for it to be long enough based off the geometry for the senior design. 

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\linewidth]{images/Senior Design/Upper Stage Pivot Axle.png}
        \caption{Cadded upper stage pivot with axle}
        \label{fig:Upper Stage Pivot}
    \end{figure}

    Although this is technically the first iteration of the senior design pivot, it met all of the expectations that were set for it. The pivot performed as intended during initial fit-up and testing, and it integrated cleanly with the rest of the assembly without creating any new issues. Because it achieved the required functionality and maintained proper alignment and clearances, no further revisions have been necessary. As a result, the pivot has remained unchanged moving forward into the current design.



\section{Upper Stage}

    This section will cover the complete upper stage along with the back part of the curve or the more common term "rib cage". We will go over any problems found during building or manufacturing along with solutions that were made during the process. 
